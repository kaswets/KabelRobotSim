...
int main()
{
    ...
    // Camera
    float camAngleX = 0.4f, camAngleY = 0.6f;
    float camScale  = 0.55f;
    ...
    while (window.isOpen())
    {
        ...
        // Frame hoeken
        Vec3 FC[8] = {
            {-LengthFrame/2, -WidhtFrame/2,  HighFrame/2},
            {-LengthFrame/2,  WidhtFrame/2,  HighFrame/2},
            { LengthFrame/2, -WidhtFrame/2,  HighFrame/2},
            { LengthFrame/2,  WidhtFrame/2,  HighFrame/2},
            {-LengthFrame/2, -WidhtFrame/2, -HighFrame/2},
        ...
        // Platform hoeken (haal uit ObjectCorner)
        Vec3 PC[8];
        for (int i=0; i<8; i++)
